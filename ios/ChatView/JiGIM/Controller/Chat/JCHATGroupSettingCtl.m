...
- (void)deleteMemberWithPersonView:(JCHATGroupPersonView *)personView {
  ...
  JMSGUser *user = [_groupData objectAtIndex:personView.headViewBtn.tag - 1000];
  [((JMSGGroup *)(self.conversation.target)) removeMembersWithUsernameArray:@[user.username] appKey:@"627f44d478abf6544b1977a0"
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
  if (alertView.tag == 300) {
    ...
    [((JMSGGroup *)(self.conversation.target)) addMembersWithUsernameArray:@[[alertView textFieldAtIndex:0].text] appKey:@"627f44d478abf6544b1977a0"
                                                         completionHandler:^(id resultObject, NSError *error) {
