...
//@"627f44d478abf6544b1977a0"                                                             completionHandler:^(id resultObject, NSError *error) {
...
- (void)deleteMemberWithUserName:(NSString *)userName {
  ...
  [((JMSGGroup *)(self.conversation.target)) removeMembersWithUsernameArray:@[userName] appKey:@"627f44d478abf6544b1977a0"
                                                          completionHandler:^(id resultObject, NSError *error) {
