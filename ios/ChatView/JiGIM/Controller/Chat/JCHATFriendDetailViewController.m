...
- (void)loadUserInfoData {
  ...
  [JMSGUser userInfoArrayWithUsernameArray:@[self.userInfo.username] appKey:@"627f44d478abf6544b1977a0"
...
- (void)switchBlack {
  ...
  if (self.userInfo.isInBlacklist) {
    ...
    [JMSGUser delUsersFromBlacklist:@[self.userInfo.username] appKey:@"627f44d478abf6544b1977a0"
                  completionHandler:^(id resultObject, NSError *error) {
                    [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
                    if (error != nil) {
    ...
    [JMSGUser addUsersToBlacklist:@[self.userInfo.username] appKey:@"627f44d478abf6544b1977a0"
                completionHandler:^(id resultObject, NSError *error) {
                  [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
                  if (error != nil) {
