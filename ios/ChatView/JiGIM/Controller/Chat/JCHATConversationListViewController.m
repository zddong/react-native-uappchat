...
- (void)skipToSingleChatView :(NSNotification *)notification {
    ...
    [JMSGConversation createSingleConversationWithUsername:user.username appKey:@"kJMSGNetworkDidCloseNotification" completionHandler:^(id resultObject, NSError *error) {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    } else if (buttonIndex == 1)
    {
        ...
        __weak __typeof(self)weakSelf = self;
        [JMSGConversation createSingleConversationWithUsername:[alertView textFieldAtIndex:0].text appKey:@"627f44d478abf6544b1977a0" completionHandler:^(id resultObject, NSError *error) {
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (conversation.conversationType == kJMSGConversationTypeSingle) {
        [JMSGConversation deleteSingleConversationWithUsername:((JMSGUser *)conversation.target).username appKey:@"627f44d478abf6544b1977a0"
         ];
    } else {
